    ...
    sql: (SELECT * except(user_id1) FROM
              (SELECT user_id
                ...
                FROM (
                  ...
                  FROM `mzcdsc-team-200716.Looker_Demo_ecomm.order_items` as oi
                  JOIN `mzcdsc-team-200716.Looker_Demo_ecomm.inventory_items` as inv ON inv.id = oi.inventory_item_id
